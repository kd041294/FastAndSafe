...
<html lang="en">
    <head>
        ...
        <link href="css/meat-fish.css" rel='stylesheet' type='text/css' />
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-4 meatfish-cards shadow bg-white rounded">
                        <h3>Mutton</h3>
                        <p>Upto 10% off</p>
                        <a href="<?php echo $routesMF['m']; ?>"><img class="category-sec-img" src="img/meatNfish/mutton.jpg" /></a>
                    </div>
                    <div class="col-12 col-sm-4 meatfish-cards shadow bg-white rounded">
                        <h3>Chicken</h3>
                        <p>Upto 12% off</p>
                        <a href="<?php echo $routesMF['c']; ?>"><img class="category-sec-img" src="img/meatNfish/chicken.png" /></a>
                    </div>
                    <div class="col-12 col-sm-4 meatfish-cards shadow bg-white rounded">
                        <h3>Fish</h3>
                        <p>Upto 15% off</p>
                        <a href="<?php echo $routesMF['f']; ?>"><img class="category-sec-img" src="img/meatNfish/fish.jpg" /></a>
                    </div>
                </div>
            </div>
