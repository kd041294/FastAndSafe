...
<html lang="en">
    <head>
        ...
        <link href="css/detergents-cleaners.css" rel='stylesheet' type='text/css' />
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-4 dcle-cards shadow bg-white rounded">
                        <h3>Detergents & Bar</h3>
                        <p>Upto 15% off</p>
                        <a href="<?php echo $routeDetClen['d']; ?>"><img class="category-sec-img" src="img/detergentsNcleaners/detergents.png" /></a>
                    </div>
                    <div class="col-12 col-sm-4 dcle-cards shadow bg-white rounded">
                        <h3>Handwash & Sanetizer</h3>
                        <p>Upto 10% off</p>
                        <a href="<?php echo $routeDetClen['hd']; ?>"><img class="category-sec-img" src="img/detergentsNcleaners/handwash.png" /></a>
                    </div>
                    <div class="col-12 col-sm-4 dcle-cards shadow bg-white rounded">
                        <h3>Cleaners</h3>
                        <p>Upto 12% off</p>
                        <a href="<?php echo $routeDetClen['c']; ?>"><img class="category-sec-img" src="img/detergentsNcleaners/cleaners.jpg" /></a>
                    </div>
                </div>
            </div>
