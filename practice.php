...
<html>
    <body>
        ...
        <?php
            ...
            $api = file_get_contents("https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=".$origin."&destinations=".$destination."&key=AIzaSyAXS-UbJDwr3pjl9L_FwWx0U7wTeEjORZ4");
...
$addressFrom = '12/c manohar pukur road, kolkata - 700026';
$addressTo   = 'khanpur road, kolkata - 700047';
...
function getDistance($addressFrom, $addressTo, $unit = ''){
    // Google API key
    $apiKey = 'AIzaSyAXS-UbJDwr3pjl9L_FwWx0U7wTeEjORZ4';
